...
class nnUNetTrainer(NetworkTrainer):
    ...
    def setup_DA_params(self):
        ...
        print("set_DA_param", self.patch_size)
        if self.do_dummy_2D_aug:
    ...
    def process_plans(self, plans):
        ...
        print("process_plans", self.patch_size)
    ...
    def predict_preprocessed_data_return_seg_and_softmax(self, data: np.ndarray, task_id: np.ndarray, do_mirroring: bool = True,
        ...
        self.network.eval()
        ret = self.network.predict_3D(data, task_id, do_mirroring=do_mirroring, mirror_axes=mirror_axes,
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        for k in self.dataset_val.keys():
            ...
            if overwrite or (not isfile(join(output_folder, fname + ".nii.gz"))) or \
                ...
                task_id = np.zeros((1,))
                task_id[0] = self.task[fname.split("_")[0]]
